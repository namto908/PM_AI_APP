...
function AlertItem({ alert, onResolve }: { alert: Alert; onResolve: (id: string) => void }) {
  ...
  return (
    <div className={`p-3 ${c.bg} border-l-2 ${c.border} rounded-r-lg`}>
      ...
      <p className="text-xs font-bold text-[#dae2fd]">{alert.title}</p>
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-3 py-1.5 rounded-lg text-xs transition-colors ${
                selectedId === s.id
                  ...
                  : 'text-slate-400 hover:bg-[#222a3d]'
              }`}
            >
              <span>{s.name}</span>
  ...
  return (
    <div className="flex-1 flex overflow-hidden p-6 gap-6">
      ...
      <div className="w-64 flex-shrink-0 flex flex-col gap-4 overflow-y-auto">
        {/* Server Fleet */}
        <section className="bg-[#131b2e] rounded-xl p-4">
        ...
        {/* Active Alerts */}
        <section className="flex-1 flex flex-col bg-[#131b2e] rounded-xl p-4 overflow-hidden min-h-0">
      ...
      <div className="flex-1 flex flex-col gap-6 overflow-y-auto
        ...
        <div className="flex items-end justify-between flex-shrink-0">
          <div>
            ...
            <h1 className="text-2xl font-bold text-[#dae2fd] tracking-tight">System Performance</h1>
          </div>
          <div className="flex bg-[#131b2e] p-1 rounded-xl gap-0.5">
            {TIME_RANGES.map((r) => (
              <button
                key={r}
        ...
        <div className="grid grid-cols-12 gap-4 flex-shrink-0">
          {/* CPU chart — 8 cols */}
          <div className="col-span-8 bg-[#131b2e] rounded-2xl p-6 relative overflow-hidden">
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  ...
                  <span className="text-sm font-bold text-[#dae2fd]">88.2%</span>
                </div>
              </div>
              {/* Bar chart */}
          ...
          <div className="col-span-4 flex flex-col gap-4">
            <div className="flex-1 bg-[#131b2e] rounded-2xl p-5 flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="w-full bg-[#222a3d] h-1 mt-2 rounded-full overflow-hidden">
              ...
              {servers.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`bg-[#171f33] rounded-xl p-4 text-left group hover:ring-1 transition-all ${
                  ...
                  >
                    ...
                    <h5 className="text-sm font-bold text-[#dae2fd] transition-colors" style={{ color: activeServer?.id === s.id ? accent : undefined }}>{s.name}</h5>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
              {SERVICE_CARDS.map((svc) => {
                ...
                return (
                  <div
                    key={svc.name}
                    className={`bg-[#171f33] rounded-xl p-4 group hover:ring-1 ${svc.ringColor} transition-all cursor-pointer`}
                  >
                    <div className="flex justify-between items-start mb-3">
                    ...
                    <h5 className={`text-sm font-bold text-[#dae2fd] group-hover:${svc.statusColor} transition-colors`}>{svc.name}</h5>
        ...
        {activeServer && (
          <section className="bg-[#171f33] rounded-2xl overflow-hidden mb-2 flex-shrink-0">
                ...
                <div className="space-y-0">
                  {[
                    ...
                    <div key={label} className="flex justify-between py-2 border-b border-slate-800/20">
                      ...
                      <span className={`text-xs font-bold ${accent !== undefined ? (accent ? 'text-[#6bd8cb]' : 'text-[#ffb4ab]') : 'text-[#dae2fd]'}`}>
                        {value}
                      </span>
                    </div>
                  ))}
                    ...
                    <div className="flex justify-between py-2">
                      ...
                      <div className="flex gap-1 flex-wrap justify-end">
                        {activeServer.tags.map((t) => (
                          <span key={t} className="text-[10px] px-1.5 py-0.5 bg-[#222a3d] text-slate-400 rounded">{t}</span>
                        ))}
                      </div>
                    </div>
                  )}
                ...
                {INCIDENTS.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {INCIDENTS.map((inc) => {
                      const Icon = inc.icon;
                      return (
                        <div key={inc.title} className="flex items-center gap-4 p-3 bg-[#222a3d] rounded-xl">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              <p className="text-xs font-bold text-[#dae2fd]">{inc.title}</p>
